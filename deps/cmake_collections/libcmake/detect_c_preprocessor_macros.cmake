    ...
    if (DEFINED CMAKE_C_COMPILER)
        if ("${CMAKE_VERSION}" VERSION_LESS "3.17.0")
            execute_process(COMMAND sh
                    "${_THIS_MODULE_BASE_DIR}/shell/detect_c_preprocessor_macros.sh"
                    "${CMAKE_C_COMPILER}"
                    c
                    "${CMAKE_BINARY_DIR}/compile_logs/")
        else ()
            execute_process(COMMAND sh
                    "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/shell/detect_c_preprocessor_macros.sh"
                    "${CMAKE_C_COMPILER}"
                    c
                    "${CMAKE_BINARY_DIR}/compile_logs/")
        endif ()
