...
void str_to_qual_foreach(am_qual_t* qual, const char* str, size_t qlen);
std::string cigar_arr_to_str(const std::vector<am_cigar_t>& cigar_arr);
[[maybe_unused]] std::string cigar_arr_to_str_old(const am_cigar_t* cigar_arr, size_t n);
std::string cigar_arr_to_str_optim(const am_cigar_t* cigar_arr, size_t n);
