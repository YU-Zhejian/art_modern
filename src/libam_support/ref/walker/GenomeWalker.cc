...
std::size_t GenomeWalker::get_seq_id() const { return seq_id_; }
hts_pos_t GenomeWalker::get_position() const { return position_; }
bool GenomeWalker::is_on_pos_strand() const { return on_pos_strand_; }
