if(DEFINED USE_HTSLIB)
    ...
    set(USED_HTSLIB_NAME "${USE_HTSLIB} (External)")
    ...
    include_directories(BEFORE SYSTEM "${CMAKE_CURRENT_LIST_DIR}/../../deps/labw_slim_htslib")
    set(USED_HTSLIB_NAME "labw_slim_htslib (Bundled)")
