...
elseif("${USE_RANDOM_GENERATOR}" STREQUAL "GSL")
    message(WARNING "GSL random generators will be deprecated in the future release.")
...
elseif("${USE_RANDOM_GENERATOR}" STREQUAL "PCG")
    ...
    include_directories(BEFORE "${CMAKE_CURRENT_LIST_DIR}/../../deps/pcg-cpp-0.98/include")
