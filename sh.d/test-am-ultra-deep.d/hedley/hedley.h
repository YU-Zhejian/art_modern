...
#endif
#endif
#if (HEDLEY_HAS_BUILTIN(__builtin_unreachable) && (!defined(HEDLEY_ARM_VERSION))) || HEDLEY_GCC_VERSION_CHECK(4, 5, 0) \
    || HEDLEY_PGI_VERSION_CHECK(18, 10, 0) || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0)                                     \
...
#elif (HEDLEY_HAS_BUILTIN(__builtin_expect) && !defined(HEDLEY_INTEL_CL_VERSION)) || HEDLEY_GCC_VERSION_CHECK(3, 0, 0) \
    || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || (HEDLEY_SUNPRO_VERSION_CHECK(5, 15, 0) && defined(__cplusplus))         \
    || HEDLEY_ARM_VERSION_CHECK(4, 1, 0) || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || HEDLEY_TI_VERSION_CHECK(15, 12, 0)   \
...
#elif HEDLEY_GCC_VERSION_CHECK(3, 1, 0) || HEDLEY_MSVC_VERSION_CHECK(14, 0, 0) || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) \
    || HEDLEY_INTEL_CL_VERSION_CHECK(2021, 1, 0) || HEDLEY_ARM_VERSION_CHECK(4, 1, 0)                                  \
...
#endif
#if HEDLEY_HAS_ATTRIBUTE(always_inline) || HEDLEY_GCC_VERSION_CHECK(4, 0, 0) || HEDLEY_INTEL_VERSION_CHECK(13, 0, 0)   \
    || HEDLEY_SUNPRO_VERSION_CHECK(5, 11, 0) || HEDLEY_ARM_VERSION_CHECK(4, 1, 0)                                      \
    || HEDLEY_IBM_VERSION_CHECK(10, 1, 0) || HEDLEY_TI_VERSION_CHECK(15, 12, 0)                                        \
    || (HEDLEY_TI_ARMCL_VERSION_CHECK(4, 8, 0) && defined(__TI_GNU_ATTRIBUTE_SUPPORT__))                               \
    || HEDLEY_TI_ARMCL_VERSION_CHECK(5, 2, 0)                                                                          \
