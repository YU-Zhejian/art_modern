...
By default, the program would **NOT** support building profiles from NCBI short-read archive (SRA). Use `-DWITH_NCBI_NGS=ON` to enable it. Additional libraries (namely, `libncbi-ngs.a`s, with its development headers) are required.
