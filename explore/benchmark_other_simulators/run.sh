...
run opt/art_modern_build/art_modern \
    ...
    --pe_frag_dist_mean 300 --pe_frag_dist_std_dev 20 --parallel 6

run bin/wgsim -1 150 -2 150 -N 185248 -d 300 -s 20 data/ce11_mrna.fa data/wgsim_1.fq data/wgsim_2.fq >data/wgsim.vcf
run bin/art_original --seqSys HS25 --in data/ce11_mrna.fa -f 10 --len 150 --mflen 300 --sdev 20 --noALN --paired --out data/art
run opt/art_modern_build/art_modern \
    --mode trans --lc pe \
    --i-file data/ce11_mrna.fa --i-fcov 10 --read_len 150 \
    --o-fastq data/art_modern_wgs_memory.fastq \
    --qual_file_1 ../../art/Illumina_profiles/HiSeq2500L150R1.txt \
    --qual_file_2 ../../art/Illumina_profiles/HiSeq2500L150R2.txt \
    --pe_frag_dist_mean 300 --pe_frag_dist_std_dev 20 --parallel 6
