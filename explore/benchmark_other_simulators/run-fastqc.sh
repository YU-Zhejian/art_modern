...
opt/art_modern_build/art_modern \
    --mode wgs --lc pe \
    --i-file data/ce11.fa --i-fcov 3 --read_len 150 \
...
seqtk seq -1 "${OUT_DIR}"/ce11_art_modern_wgs_memory.fastq >"${OUT_DIR}"/ce11_art_modern_wgs_memory_1.fastq
seqtk seq -2 "${OUT_DIR}"/ce11_art_modern_wgs_memory.fastq >"${OUT_DIR}"/ce11_art_modern_wgs_memory_2.fastq
rm -f "${OUT_DIR}"/ce11_art_modern_wgs_memory.fastq
